...
| 工具名 | 说明 |
|--------|------|
| `sx-dispatch` | 智能分流（借鉴 SkillForge） |
| `sx_list` | 列出所有技能 |
| `sx_read` | 读取技能内容 |
| `sx_create` | 创建新技能 |
| `sx_update` | 更新技能 |
...
SkillForge 的 Phase 0 "Universal Skill Dispatch" 是一个非常优秀的设计：
...
- **SkillForge** - 在 sp_dispatch 的返回值设计中使用 XML
