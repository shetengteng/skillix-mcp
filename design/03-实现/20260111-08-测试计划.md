...
- `tests/tools/dispatchs.test.ts` - sx-dispatch 工具测试
...
```
 ...
 ✓ tests/services/dispatch.test.ts  (8 tests) 136ms
 ...
 ✓ tests/tools/dispatchs.test.ts  (16 tests) 221ms
