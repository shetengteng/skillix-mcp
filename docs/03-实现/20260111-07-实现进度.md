...
| **Phase 3** | 技能市场 (sx_market) | ⏳ 待实现 |
| **Phase 4** | 智能分流 (sx_triage) | ⏳ 待实现 |
...
#### sx_config 工具 (`src/tools/configs/`)
- [x] `get.ts` - 获取配置子命令
- [x] `set.ts` - 设置配置子命令
- [x] `init.ts` - 初始化项目子命令
...
#### sx_market 工具 (`src/tools/markets/`)
- [ ] `search.ts` - 搜索技能子命令
- [ ] `install.ts` - 安装技能子命令
...
#### sx_triage 工具 (`src/tools/triages/`)
- [ ] `analyze.ts` - 分析任务子命令
- [ ] `index.ts` - 工具入口和定义
...
│   │   ├── skill.ts         # ✅ 技能帮助
│   │   └── config.ts        # ✅ 配置帮助
│   ├── markets/             # ⏳ sx_market 工具（待实现）
│   └── triages/             # ⏳ sx_triage 工具（待实现）
├── services/                # 业务服务层
│   ├── index.ts             # ✅ 统一导出
│   ├── skill.ts             # ✅ 技能管理服务
│   ├── config.ts            # ✅ 配置管理服务
...
| `tests/tools/skills.test.ts` | sx_skill 工具 | ✅ 通过 |
| `tests/tools/configs.test.ts` | sx_config 工具 | ✅ 通过 |
| `tests/tools/helps.test.ts` | sx_help 工具 | ✅ 通过 |
...
└── tools/
    ├── skills.test.ts      # ✅ sx_skill 工具测试
    ├── configs.test.ts     # ✅ sx_config 工具测试
    └── helps.test.ts       # ✅ sx_help 工具测试
```
